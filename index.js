...
const token = 'NTg4MDM4NTg5NDE4MzA3NjMy.XQOrbg.M6sfw4YIFkDimSY_fz6l_ylV-pI';

const PREFIX = '!';

bot.on('ready', () => {
    console.log('This bot is online!');
    bot.user.setActivity('nach Caillous Haaren', { type: 'WATCHING' });
})
...
bot.on('message', message => {
    ...
    switch (args[0]) {
        ...
        case "ping":
            message.channel.sendMessage('Du hast einen Ping von 10000')
        break;
